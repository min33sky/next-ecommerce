              ...
              <div className="flex h-96 gap-x-8">
                ...
                <div className="flex flex-1 flex-col">
                  ...
                  <div className="space-y-3 text-sm">
                    <button className="button w-full border-transparent bg-blue-600 text-white hover:border-blue-600 hover:bg-transparent hover:text-black">
                      Add to bag
                    </button>
                    <button
                      onClick={() => window.location.reload()}
                      className="button w-full border-blue-600 bg-transparent hover:border-transparent hover:bg-blue-600 hover:text-white"
                    >
                      View full details
                    </button>
                  </div>
